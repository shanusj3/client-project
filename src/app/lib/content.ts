export const content = {
  ...
  hero: {
    ...
    experienceBlock: {
      ...
      description: "Leveraging over 38 years of leadership in engineering and manufacturing to provide world-class solutions tailored to meet the evolving needs of global and domestic clients.",
      buttons: [
        { name: "Our Services", href: "/services" },
        { name: "Get In Touch", href: "#contact" }
      ],
      stats: [
        { label: "Years of Experience", value: "38+", icon: "Award" },
  ...
  services: {
    ...
    subtitle: "We partner with businesses to drive innovation, expand globally, and create long-term value through strategic engineering and advisory.",
  ...
  products: {
    title: "High-Performance Industrial Products",
    subtitle: "We facilitate the manufacturing and supply of precision-engineered industrial products designed for global standards.",
    items: [
      {
        id: "machined-parts",
        icon: "Cpu",
        title: "Precision Machined Components",
        description: "High-tolerance components for Aerospace, Defense, and Medical sectors manufactured using advanced CNC technologies.",
      ...
      },
      {
        ...
        description: "Custom-engineered heat exchangers, pressure vessels, and filtration systems for the Oil & Gas and Chemical industries.",
        image: "https://images.unsplash.com/photo-1542601906-e339662ad24c?q=80&w=1000"
      },
      {
        id: "iot-solutions",
        icon: "Zap",
        title: "Industrial IoT & Automation Solutions",
        description: "Smart sensors, data acquisition systems, and automation panels designed for Industry 4.0 integration.",
      ...
      },
      {
        ...
        description: "Specialized jigs, fixtures, and assembly tooling designed to optimize production efficiency in heavy machinery manufacturing.",
        image: "https://images.unsplash.com/photo-1503691750548-ad2336719b67?q=80&w=1000"
      }
    ]
  },
  contact: {
    title: "Let's Build Something Great",
    description: "Have a project in mind or exploring opportunities in India? Our team is here to help you take the next step.",
    location: "Ahmedabad, Gujarat, India",
    email: "contact@sesil.in",
    phone: "+91 79 1234 5678",
    linkedin: "https://linkedin.com/company/sesil",
    businessHours: "9:30 AM – 6:30 PM (IST)",
    cta: "Send Message"
  },
  headerNavLinks: [
    { name: "Home", href: "/" },
